...
const ButtonGroupRoot = (0, _styled.default)('div', {
  ...
  var _theme$vars$palette, _theme$vars$palette2, _theme$vars$palette3, _theme$vars$palette4;
  ...
  return [(0, _extends2.default)({
    ...
    [`& > :not([data-first-child]):not([data-last-child])`]: (0, _extends2.default)({
    ...
    [theme.getColorSchemeSelector('dark')]: (0, _extends2.default)({}, ownerState.color !== 'context' && (0, _extends2.default)({}, ownerState.variant !== 'outlined' && {
      '--ButtonGroup-separatorColor': (_theme$vars$palette4 = theme.vars.palette[ownerState.color]) == null ? void 0 : _theme$vars$palette4[700]
    }))
  }];
});
